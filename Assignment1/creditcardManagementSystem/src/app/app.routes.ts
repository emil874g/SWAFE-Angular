...
export const routes: Routes = [
  ...
  { path: 'credit-card/:id', loadComponent: () => import('./credit-card/credit-card-details/credit-card-details.component').then(m => m.CreditCardDetailsComponent), canActivate: [authGuard] },
